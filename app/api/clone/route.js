...
export async function POST(request) {
  try {
    ...
    const voiceName = formData.get("voiceName")?.trim() || "My Monstah Clone";
    ...
    if (!voice_id) {
      ...
      createVoiceFormData.append("name", voiceName);
      createVoiceFormData.append("files", audioFile);
      createVoiceFormData.append("description", "Voice clone generated by Monstah Voice Cloner");
    ...
    try {
      ...
      // Step 3: Delete the temporary voice clone (unless user chose to save it)
